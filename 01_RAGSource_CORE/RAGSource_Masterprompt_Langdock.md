...
  access_method: "Langdock GitHub Integration"

  

  commands: ["get file content","get repository content"]

  

  Owner: "amtsschimmel-ai"

  

  Repository: "ragsource"

  

  Paths: "always relative to repository"

  

  ragindex_url: "/02_RAGSource_PROJECT/RAGIndex.md"

  

  extended_rules: "/01_RAGSource_CORE/RAGSource_sys.md"
...
      url: "/02_RAGSource_PROJECT/RAGIndex.md"
...
      - "NEVER USE LLM KNOWLEDGE WITHOUT ASKING USER FOR LEGAL CONTENT"

  

      - "NEVER BYPASS THE USE OF THE RAGIndex AND RAGSource KNOWLEDGE ARTICLES. NO SHORTCUTS ALLOWED."
